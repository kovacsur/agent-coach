...
- On a critical path, don't foreclose failure ("do not stop until…", "at all costs"). State the goal, then rank the outcomes: stopping with a report beats reaching the goal off-spec.
